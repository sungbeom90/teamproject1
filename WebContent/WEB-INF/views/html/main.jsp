		...
		<div class="container">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#all_country_tab">ì ì²´ ëë¼</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#all_city_tab">ì ì²´ ëì</a></li>
			</ul>
			<div class="tab-content mt-3">
				<div class="hbox">
					<button id="login">ë¡ê·¸ì¸ìí</button>
					<button id="logout">ë¡ê·¸ìììí</button>
				</div>
				...
				<div id="all_country_tab" class="container tab-pane fade">
					<div class="container mt-5">
						<h2>ì ì²´ ëë¼</h2>
						<input class="form-control" id="input_country" type="text"
							placeholder="ì°¾ì¼ì¤ ëìë¥¼ ê²ìí´ì£¼ì¸ì..">
						<div id="all_country" class="container mt-3">
							<a href="">ì¤íì¸</a> <a href="">ë¯¸êµ­</a> <a href="">ì¼ë³¸</a> <a href="">íêµ­</a>
						</div>
					</div>
				</div>
				<div id="all_city_tab" class="container tab-pane fade">
					<div class="container mt-5">
						<h2>ì ì²´ ëì</h2>
						<input class="form-control" id="input_city" type="text"
							placeholder="ì°¾ì¼ì¤ ëìë¥¼ ê²ìí´ì£¼ì¸ì..">
						<div id="all_city" class="container mt-3">
							<a href="">ë°ë¥´ìë¡ë</a> <a href="">ë´ì</a> <a href="">ì¤í¤ëì</a> <a
								href="">ë¶ì°</a>
						</div>
					</div>
				</div>
